...
function validateContent(content) {
  ...
  const links = [content.hero.linkUrl, content.footer.githubUrl, content.footer.linkedinUrl, content.footer.instagramUrl, content.hero.portraitUrl, content.hero.reelUrl,

...
export default function Home() {
  ...
  const savedPortrait = safeWebUrl(content.hero.portraitUrl);
  const portrait = savedPortrait && savedPortrait !== templateMedia.portrait ? savedPortrait : '/images/portrait.webp';

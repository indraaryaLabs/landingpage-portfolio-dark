  ...
  return <div className="portfolio">
    ...
    <main id="top">
      <section className="pf-hero" aria-labelledby="pf-title">
        ...
        <div className="pf-hero-main">
          <div>
            ...
            <h1 id="pf-title">Building software<br />that <em>holds up.</em></h1>
            <p className="pf-hero-copy">Junior software engineer with freelance full-stack experience. I build practical applications, connect reliable APIs and data, and care about what happens after code ships.</p>
      ...
      <section className="pf-section pf-work" id="work">
        <SectionHeading number="01" note="EXPERIENCE" title={<>Work built in<br /><em>real contexts.</em></>} />
      ...
      <section className="pf-section pf-projects" id="projects">
        ...
        <div className="pf-project-grid">{projects.map((item) => <article className="pf-project" key={item.name}>
          <div className={`pf-project-art pf-art-${item.art}`} aria-hidden="true">
            {item.art === 'mobile' && <div className="pf-phone"><div className="pf-phone-bar" /><div className="pf-phone-title">Jejak Karier</div><div className="pf-phone-stat"><b>Applications</b><span>Track your next step</span></div><div className="pf-phone-row" /><div className="pf-phone-row short" /><div className="pf-phone-row" /></div>}
            {item.art === 'systems' && <div className="pf-system"><div className="pf-system-top">SERVICE STATUS <span>● LIVE</span></div><div className="pf-system-chart"><i /><i /><i /><i /><i /><i /><i /><i /><i /><i /></div><div className="pf-system-line"/><div className="pf-system-line short"/></div>}
            {item.art === 'data' && <div className="pf-data-visual"><span>EXTRACT</span><b>→</b><span>TRANSFORM</span><b>→</b><span>EXPORT</span><div className="pf-data-grid" /></div>}
          </div>
